...
export default function Projects(){
    ...
    const projects = [
        {title: "FinanceApp", img: financeapp, video: financeapp_video, description: "Este é um aplicativo de controle financeiro desenvolvido em React.js, utilizando o Firebase como Backend as a Service (BaaS). O aplicativo permite aos usuários gerenciar suas finanças pessoais de forma eficiente e intuitiva.", code: "https://github.com/KetsonKersen/FianceApp?tab=readme-ov-file#-financeapp", deploy:"https://fiance-app-sable.vercel.app/"},
